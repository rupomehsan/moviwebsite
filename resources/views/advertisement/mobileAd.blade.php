    ...
    {{-- <div class="row margin-top-40">
        <div class="col-md-2 content-type">
            <div class="content-type-element content-type-active">
                <a class="bold several-ad several-ad-active" href="/admin/advertisement">Add For Mobile</a>
            </div>
        </div>

        <div class="col-md-2 content-type">
            <div class="content-type-element">
                <a class="bold several-ad several-ad-inactive" href="/admin/advertisement/web-ad">Add For Web</a>
            </div>
        </div>
...
if (!empty($ses_msg)) {
    ...
    <form id="mobileAdForm" method="POST" enctype="multipart/form-data"
        ...
        <div class="row margin-top-40">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 col-sm-4 text-right">
                                            <input type="checkbox" name="google_status[google]" id="googleStatus"
                                                class="ad-switch" {!! $data->google_status == 'on' ? 'checked' : '' !!}>
                                ...
                                <div class="ad-body">
                                    ...
                                    <div class="native-details">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="native_per_video_like[google]"
                                                value="{!! $data->native_per_video_like ?? '' !!}" class="form-control create-form"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="app_open_id[google]" class="form-control create-form"
                                            id="googleAppOpenAdmob" value="{!! $data->app_open_id ?? '' !!}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 col-sm-4 text-right">
                                            <input type="checkbox" name="facebook_status[facebook]" id="facebookStatus"
                                                class="ad-switch" {!! $data->facebook_status == 'on' ? 'checked' : '' !!}>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 col-sm-4 text-right">
                                            <input type="checkbox" name="custom_status[custom]" id="customStatus"
                                                class="ad-switch" {!! $data->custom_status == 'on' ? 'checked' : '' !!}>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <p>
                                                    @if (!empty($data->banner_image))
                                                        <img src="{{ URL::to('/') }}/uploads/ad/{{ $data->banner_image }}"
                                        ...
                                        <div class="col-md-6 custom-interseticial">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <p>
                                                    @if (!empty($data->interesticial_image))
                                                        <img src="{{ URL::to('/') }}/uploads/ad/{{ $data->interesticial_image }}"
                                        ...
                                        <div class="col-md-6 native-interseticial">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <p>
                                                    @if (!empty($data->native_image))
                                                        <img src="{{ URL::to('/') }}/uploads/ad/{{ $data->native_image }}"
                                        ...
                                        <div class="col-md-6 custom-banner margin-top-20">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <p>
                                                    @if (!empty($data->app_open_image))
                                                        <img src="{{ URL::to('/') }}/uploads/ad/{{ $data->app_open_image }}"
                                            ...
                                            <div class="form-group margin-top-20">
                                                ...
                                                <input type="text" name="app_open_link[custom]"
                                                    value="{!! $data->app_open_link ?? '' !!}" class="form-control create-form"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 col-sm-4 text-right">
                                            ...
                                            <input type="checkbox" name="startup_status[startup]" id="startupStatus"
                                                class="ad-switch" {!! $data->startup_status == 'on' ? 'checked' : '' !!}>
                                        ...
                                        <div class="col-md-6 startup-banner">
                                            ...
                                            <div class="form-group margin-top-20">
                                                ...
                                                <input type="text" name="startup_id[startup]"
                                                    value="{!! $data->startup_id ?? '' !!}" class="form-control create-form"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 col-sm-4 text-right">
                                            ...
                                            <input type="checkbox" name="unity_status[unity]" id="unityStatus"
                                                class="ad-switch" {!! $data->unity_status == 'on' ? 'checked' : '' !!}>

                                            {{-- <div class="form-check form-switch">
                                                <input class="form-check-input" name="unity_status[unity]"
                                                    type="checkbox" id="unityStatus" {!! $data->unity_status == 'on' ? 'checked' : '' !!}>
                                            </div> --}}
                                        </div>
                                    </div>
                                </div>
                                <div class="ad-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="banner_id[unity]" class="form-control create-form"
                                            id="unityBannerAdmob" value="{!! $data->banner_id ?? '' !!}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="interesticial_id[unity]" class="form-control create-form"
                                            id="unityInteresticialAdmob" value="{!! $data->interesticial_id ?? '' !!}">
                                    </div>
                                    <div class="interesticial-details">
                                        <div class="form-group">
            ...
            {{-- Start::app_lovin_max ad --}}
            @if (!$target->isEmpty())
            @foreach ($target as $data)
                @if ($data->ad_type == 'app_lovin_max')
                            ...
                            <div class="ad-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="banner_id[app_lovin_max]" class="form-control create-form"
                                        id="app_lovin_maxBannerAdmob" value="{!! $data->banner_id ?? '' !!}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="interesticial_id[app_lovin_max]" class="form-control create-form"
                                        id="app_lovin_maxInteresticialAdmob" value="{!! $data->interesticial_id ?? '' !!}">
                                </div>
                                <div class="interesticial-details">
                                    <div class="form-group">
        ...
        @endif
        {{-- End::app_lovin_max ad --}}

            {{-- Start::iron ad --}}
            @if (!$target->isEmpty())
                @foreach ($target as $data)
                    @if ($data->ad_type == 'iron')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 col-sm-4 text-right">
                                            ...
                                            <input type="checkbox" name="iron_status[iron]" id="ironStatus"
                                                class="ad-switch" {!! $data->iron_status == 'on' ? 'checked' : '' !!}>

                                            {{-- <div class="form-check form-switch">
                                            <input class="form-check-input" name="iron_status[iron]"
                                                type="checkbox" id="ironStatus" {!! $data->iron_status == 'on' ? 'checked' : '' !!}>
                                        </div> --}}
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 iron-banner">
                                            ...
                                            <div class="form-group margin-top-20">
                                                ...
                                                <input type="text" name="iron_id[iron]" value="{!! $data->iron_id ?? '' !!}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 col-sm-4 text-right">
                                            ...
                                            <input type="checkbox" name="next_status[next]" id="nextStatus"
                                                class="ad-switch" {!! $data->next_status == 'on' ? 'checked' : '' !!}>

                                            {{-- <div class="form-check form-switch">
                                            <input class="form-check-input" name="next_status[next]"
                                                type="checkbox" id="nextStatus" {!! $data->next_status == 'on' ? 'checked' : '' !!}>
                                        </div> --}}
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 next-banner">
                                            ...
                                            <div class="form-group margin-top-20">
                                                ...
                                                <input type="text" name="next_id[next]" value="{!! $data->next_id ?? '' !!}"
