...
@section('content')
    <div class="frontend-login-pannel row margin-top-150">
        <div class="frontend-login-title col-md-12 text-center">Verify Your Email</div>
        ...
        <div class="col-md-6">
            <form id="verification" method="POST" enctype="multipart/form-data">
                ...
                <div class="input-group mb-3">
                    ...
                    <input id="code" type="code" class="form-control @error('code') is-invalid @enderror" name="verification_code"
                         placeholder="Enter Verification code" required autocomplete="code"
                        aria-describedby="basic-addon1">
                </div>

                <div class="form-group text-center margin-top-40">
                    <button type="submit" class="btn btn-danger email-submit code-submit login-submit-button">
                        Send
                    </button>
                </div>
            </form>
    ...
    <script type="text/javascript">
        ...
        $(document).on("click", ".code-submit", function(e) {
            ...
            $('.loading-spinner').css("display", "flex");
                        $.ajax({
                url: window.origin + '/api/v1/auth/user-verify',
                type: 'POST',
                dataType: "json",
                processData: false,
                contentType: false,
