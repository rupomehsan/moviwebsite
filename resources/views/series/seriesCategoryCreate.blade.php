<div class="modal-content">
    <div class="modal-title">
        <h4>Add Series Category</h4>
        <div class="title-line"></div>
    </div>
    <form id="seriesCategoryCreateForm" method="POST" enctype="multipart/form-data">
        <div class="form-group margin-top-20">
            <input name="name" type="text" class="form-control create-form" id="name" placeholder="Series Category Name">
        </div>
        ...
        <div class="actions margin-top-10">
            <button class="submit margin-top-10" type="submit" id="createSeriesCategory">Save</button>
