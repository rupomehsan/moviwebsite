        ...
        <div class="row create-body margin-top-20">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <span class="text-danger">{{ $errors->first('duration_hour') }}</span>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 margin-top-20">
                        ...
                        <div class="file-upload-sec">
                            ...
                            <span class="text-danger">{{ $errors->first('thumbnail_vertical') }}</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    {{-- <div class="col-md-4 margin-top-20">
                        <div class="form-check form-switch">
                            ...
                            <input class="form-check-input" name="video_on_off" type="checkbox" id="videoOnOff" checked>
