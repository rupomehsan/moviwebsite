...
@section('data_count')
    ...
    <form id="videoUpdateForm" method="POST" enctype="multipart/form-data">
        ...
        <div class="row create-body margin-top-20">
            ...
            <div class="col-md-6 ">
                <div class="form-group">
                    <input name="title" type="text" class="form-control create-form" id="title"
                        placeholder="Video Title" value="{{ $target->title ?? '' }}">
            ...
            <div class="col-md-6 ">
                <div class="form-group">
                    <input name="year" type="text" class="form-control create-form" id="year"
                        placeholder="Publishing Year" value="{{ $target->year ?? '' }}">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" name="duration_hour" class="form-control create-form" id="duration"
                            ...
                            value="{{ $target->duration_hour ?? '' }}">
                        <div class="input-group-prepend">
                            <span class="input-group-text">hour</span>
                        </div>
                        <input type="number" name="duration" class="form-control create-form" id="duration" min="0"
                            max="60" placeholder="Enter Minute" value="{{ $target->duration ?? '' }}">
                        <div class="input-group-prepend">
                            <span class="input-group-text">min</span>
                        </div>
                        <input type="number" name="duration_sec" class="form-control create-form" min="0"
                            max="60" placeholder="Enter Secound" value="{{ $target->duration_sec ?? '' }}">
                        <div class="input-group-prepend">
                            <span class="input-group-text">sec</span>
                        </div>
                    </div>
                    {{-- <input type="number" name="duration" class="form-control create-form" id="duration"
                        placeholder="Video Duration in Minutes" value="{{ $target->duration ?? '' }}"> --}}
            ...
            <div class="col-md-6 ">
                <div class="form-select">
                    <select name="video_type" id="videoType" class="form-control create-form">
                        ...
                        <option value="1" {{ $target->video_type == '1' ? 'selected' : '' }}>YouTube</option>
                        <option value="2" {{ $target->video_type == '2' ? 'selected' : '' }}>Vimeo</option>
                        <option value="3" {{ $target->video_type == '3' ? 'selected' : '' }}>Daily Motion</option>
                        <option value="4" {{ $target->video_type == '4' ? 'selected' : '' }}>Local Video</option>
                        <option value="5" {{ $target->video_type == '5' ? 'selected' : '' }}>Another Server
                        </option>
                    </select>
            ...
            <div class="col-md-6  {{ $class }}" id="urlContent">
                <div class="form-group">
                    <input name="url" type="text" class="form-control create-form" id="url"
                        placeholder="Video URL" value="{{ $target->url ?? '' }}">
            ...
            <div class="col-md-6 {{ $class }}" id="videoArea">
                    ...
                    <div class="file-upload-content-video">
                        ...
                        <div class="video-title-wrap">
                            <button type="button" onclick="removeUploadVideo()" class="remove-video">Remove
                                {{-- <span class="video-title">Uploaded Video</span> --}}
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 ">
                <div class="form-group">
                    <input name="slug" type="text" class="form-control create-form" id="slug"
                        placeholder="Slug (https://www.xflix.com/movie_name)" value="{{ $target->slug ?? '' }}">
            ...
            <div class="col-md-6 ">
                <div class="form-select">
                    <select name="type" id="type" class="form-control create-form">
                        <option value="free" {{ $target->type == 'free' ? 'selected' : '' }}>Free</option>
                        <option value="premium" {{ $target->type == 'premium' ? 'selected' : '' }}>Premium</option>
                    </select>
            ...
            <div class="col-md-6 ">
                <div class="form-group">
                    <input name="trailer" type="text" class="form-control create-form" id="trailer"
                        placeholder="Video Trailer (Youtube Only)" value="{{ $target->trailer ?? '' }}">
                                ...
                                <div class="file-upload-content-edit">
                                    <div class="image-title-wrap-edit">
                                        <img class="file-upload-image-edit"
                                            src="{{ URL::to('/') }}/uploads/video/thumbnail/{{ $target->thumbnail }}"
                                            alt="your image" />
                        ...
                        <div class="file-upload-edit-sec video-vertical">
                            ...
                            <div class="file-upload-content-edit-sec">
                                <img class="file-upload-image-edit-sec"
                                    src="{{ URL::to('/') }}/uploads/video/thumbnail/{{ $target->thumbnail_vertical }}"
                                    alt="your image" />
                    ...
                    <div class="col-md-4 margin-top-20">
                        <div class="form-check form-switch">
                            ...
                            <input class="form-check-input" name="send_notification" type="checkbox"
                                id="send_notification" {{ $target->send_notification == 'on' ? 'checked' : '' }}>
                            <span class="text-danger">{{ $errors->first('send_notification') }}</span>
                        </div>
                    </div>

                    {{-- <div class="col-md-4 margin-top-20">
                        <div class="form-check form-switch">
                            <label class="form-check-label" for="videoOnOff">Video - off/on</label>
                            <input class="form-check-input" name="video_on_off" type="checkbox" id="videoOnOff"
                                {{ $target->video_on_off == 'on' ? 'checked' : '' }}>
                            <span class="text-danger">{{ $errors->first('video_on_off') }}</span>
                        </div>
                    </div> --}}
                    ...
                    <div class="col-md-4 margin-top-20">
                        <div class="form-check form-switch">
                            ...
                            <input class="form-check-input" name="comment_on_off" type="checkbox" id="commentOnOff"
                                {{ $target->comment_on_off == 'on' ? 'checked' : '' }}>
                            <span class="text-danger">{{ $errors->first('comment_on_off') }}</span>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 margin-top-20">
                        <div class="form-check form-switch">
                            ...
                            <input class="form-check-input" name="is_series" type="checkbox" id="seriesYesNo"
                                {{ $target->is_series == 'on' ? 'checked' : '' }}>
                            <span class="text-danger">{{ $errors->first('is_series') }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="seriesContents" class="{{ $class }} margin-top-10">
                <div class="row">
                            ...
                            <select name="series_category_id" id="seriesCategoryId" class="form-control create-form">
                                ...
                                @if (!empty($seriesCategoryList))
                                    @foreach ($seriesCategoryList as $id => $name)
                                        ...
                                        ?>
                                        <option value="{{ $id }}" {{ $checked }}>{{ $name }}
                                        </option>
                                    @endforeach
                                @endif
                            </select>
                            <span class="text-danger">{{ $errors->first('series_category_id') }}</span>
                        </div>
                    </div>
                    ...
                    {{-- <div class="col-md-6 margin-top-10 display-none" id="seasonContentText">
                        <div class="form-group">
                            <input name="season_name" type="text" class="form-control create-form" id="season"
                                placeholder="Season Name" value="{{ $target->season ?? '' }}">
                        </div>
                    </div> --}}
                    ...
                    <div class="col-md-6 " id="episodContent">
                        <div class="form-select">
                            ...
                            <span class="text-danger">{{ $errors->first('episod_id') }}</span>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-check form-switch margin-top-20">
                        ...
                        {{ $target->is_trending == 'on' ? 'checked' : '' }}>
                        <span class="text-danger">{{ $errors->first('is_trending') }}</span>
                    </div>
                </div>
                <div class="col-md-6 margin-top-10">
                    <div class="form-group">
                        <input name="fake_view" type="number" class="form-control create-form" id="fake_view"
                            placeholder="Fake Views" value="{{ $target->fake_view ?? '' }}">
                        <span class="text-danger">{{ $errors->first('fake_view') }}</span>
                    </div>
                </div>
                <div class="col-md-12">
            ...
            <div class="col-md-6">
                <div class="form-select">
                    <select name="celebrity_id[]" multiple="multiple" id="videoActor" class="form-control create-form">
                        @if (!empty($celebrityList))
                            @foreach ($celebrityList as $id => $name)
                                <?php
                                $checked = '';
            ...
            <div class="col-md-6 ">
                <div class="form-group">
                    <input name="director" type="text" class="form-control create-form" id="director"
                        placeholder="Enter Director Name" value="{{ $target->director ?? '' }}">
            ...
            <div class="col-md-6 ">
                <div class="form-group">
                    <input name="writer" type="text" class="form-control create-form" id="writer"
                        placeholder="Enter Writer Name" value="{{ $target->writer ?? '' }}">
            ...
            <div class="col-md-6">
                <div class="form-select">
                    <select name="tmdb_type" id="tmdb_type" class="form-control create-form">
                        <option value="movie" {{ $target->tmdb_type == 'movie' ? 'selected' : '' }}>Movie (TMDB)</option>
                        <option value="tv" {{ $target->tmdb_type == 'tv' ? 'selected' : '' }}>TV Shows (TMDB)</option>
                    </select>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <input name="imdb_id" type="text" class="form-control create-form" id="imdbId"
                        placeholder="TMDB ID" value="{{ $target->imdb_id ?? '' }}">
                    <span class="text-danger">{{ $errors->first('imdb_id') }}</span>
                    ...
                    ?>
                    <div class="form-check margin-top-10 {{ $displayTmdb }}" id="showTmdb">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <input name="seo_title" type="text" class="form-control create-form" id="seo_title"
                        placeholder="Write SEO Title Here" value="{{ $target->seo_title ?? '' }}">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <textarea class="form-control create-form" id="meta_description" name="meta_description" rows="10"
                        placeholder="Write Meta Description Here">{{ $target->meta_description ?? '' }}</textarea>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <textarea class="form-control create-form" id="focus_keyword" name="focus_keyword" rows="10"
                        placeholder="Write Focus Keyword Here (use comma(,) to separate keyword)">{{ $target->focus_keyword ?? '' }}</textarea>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <textarea class="form-control create-form" id="seo_tag" name="seo_tag" rows="10"
                        placeholder="Write SEO Tag Here (use comma(,) to separate tags)">{{ $target->seo_tag ?? '' }}</textarea>
                </div>
            </div>
