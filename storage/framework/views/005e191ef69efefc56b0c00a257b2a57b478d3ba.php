<div class="modal-content">
    ...
    <form id="categoryCreateForm" method="POST" enctype="multipart/form-data">
        ...
        <div class="actions margin-top-10">
            <button class="submit margin-top-10" type="submit" id="createCategory">Save</button>
            <button type="button" class="cancel margin-top-10" data-dismiss="modal">Cancel</button>
        </div>
    </form>

</div>
<?php /**PATH /home/projectx/Desktop/laravelProjects/movieflix-main/resources/views/category/categoryCreate.blade.php ENDPATH**/ ?>