        ...
        <div class="report-box">
            ...
            <form id="reportCreateForm" method="POST" enctype="multipart/form-data">
                <div class="text-center">
                    <img src="<?php echo e(URL::to('/')); ?>/uploads/report.png" alt="" /> <br><br>
                    <span class="report-title">Report Movie ?</span>
                </div>

                <input type="hidden" name="video_id" value="<?php echo e($request->video_id); ?>">
...
<?php /**PATH /home/projectx/Desktop/laravelProjects/movieflix-main/resources/views/report/create.blade.php ENDPATH**/ ?>