<div class="modal-content">
    <div class="modal-title">
        <h4>Edit TV Channel Category</h4>
    ...
    <form id="categoryEditForm" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group margin-top-20">
            <input name="name" type="text" class="form-control create-form" id="name" placeholder="Tv Channel Category Name" value="<?php echo e($target->name); ?>">
        </div>
...
<?php /**PATH /home/ccninfot/movieflix.ccninfotech.com/resources/views/category/tvCategoryEdit.blade.php ENDPATH**/ ?>