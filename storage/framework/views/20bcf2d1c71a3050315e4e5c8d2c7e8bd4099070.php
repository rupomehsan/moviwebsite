...
<div class="modal-content">
    ...
    <form id="sponsorVideoCreateForm" method="POST" enctype="multipart/form-data">
        ...
        <div class="actions margin-top-10">
            <button class="submit margin-top-10" type="submit" id="createSponsorVideo">Save</button>
            <button type="button" class="cancel margin-top-10" data-dismiss="modal">Cancel</button>
        </div>
    </form>
</div>
<?php /**PATH /home/ccninfot/movieflix.ccninfotech.com/resources/views/sponsor/sponsorVideoCreate.blade.php ENDPATH**/ ?>