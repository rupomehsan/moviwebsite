    ...
    <div class="content-heading">
        <div class="row">
            ...
            <div class="col-md-4 text-right">
                <form action="/admin/admin/super-admin/filter" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ccninfot/movieflix.ccninfotech.com/resources/views/admin/superAdminIndex.blade.php ENDPATH**/ ?>