<div class="modal-content">
    ...
    <form id="countryEditForm" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group margin-top-20">
            <input name="name" type="text" class="form-control create-form" id="name" placeholder="Country Name" value="<?php echo e($target->name); ?>">
        </div>
        ...
        <div class="file-upload-edit <?php echo $target->file_type == 'link' ? 'display-none-urgent' : ''; ?>">
            ...
            <div class="file-upload-content-edit">
                <div class="image-title-wrap-edit">
                    <img class="file-upload-image-edit" src="<?php echo e(URL::to('/')); ?>/uploads/country/<?php echo e($target->image); ?>" alt="your image" />
...
<?php /**PATH /home/ccninfot/movieflix.ccninfotech.com/resources/views/country/edit.blade.php ENDPATH**/ ?>