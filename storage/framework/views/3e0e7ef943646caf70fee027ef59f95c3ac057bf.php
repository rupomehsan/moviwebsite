                                            ...
                                            <div class="video-title margin-top-54">
                                                ...
                                                <div class="video-details margin-top-10">
                                                    ...
                                                    <div class="details-line trailer">
                                                        <a href="#"
                                                            class="watch-trailer-btn  <?php echo !empty($data->trailer) ? '' : 'no-trailer-avilable'; ?>"
    ...
    <?php if(!empty($categoryShow)): ?>
        ...
        <?php $__currentLoopData = $categoryShow; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="container margin-top-20">
                ...
                <div class="homepage-video-pannel-title">
                    <div class="title">
                        <a href="<?php echo e(url('/category-index?category_id=' . $id)); ?>">
                        <?php echo e($name); ?>
...
<?php echo $__env->make('frontend.layouts.client.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tausif/Desktop/rupom/mainProject/ movieflix/resources/views/frontend/client/index.blade.php ENDPATH**/ ?>