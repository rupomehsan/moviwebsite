        ...
        <div class="row">
            ...
            <div class="col-md-8 content-title">
                <div class="row">
                    <div class="col-md-2">
                        <span class="title">
                            <a href="/admin/sponsor" class="title-btn red">Sponsor Banner</a>
                        </span>
                        <div class="title-line category-title-line" id="categoryLine"></div>
                    </div>
                    <div class="col-md-2">
                        <span class="sub-title">
                            <a href="/admin/sponsor/sponsor-video-index" class="title-btn">Sponsor Video</a>
                        </span>
                ...
                <div class="row create-menus margin-top-10">
                    ...
                    <div class="col-md-3">
                        <button type="button" class=" margin-top-10" data-toggle="modal" data-target="#createModal"
                            ...
                            <span class="iconify" data-icon="bi:plus-circle-fill"></span> &nbsp; Add Sponsor Banner
                        </button>
                    </div>
            ...
            <div class="col-md-4 text-right">
                <form action="/admin/sponsor/sponsor-banner-filter" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="content-image text-center">
                        ...
                        <?php else: ?>
                            <?php if(!empty($data->image)): ?>
                                <img src="<?php echo e(URL::to('/')); ?>/uploads/sponsor/<?php echo e($data->image); ?>" alt="<?php echo e($data->title); ?>"
                    ...
                    <div class="actions-area">
                        ...
                        <div class="dropdown-menu single-content-wraper">
                            <button title="Edit" class="popup-action-button" type="button" data-toggle="modal"
                                data-target="#createModal" id="editBtn" data-id="<?php echo e($data->id); ?>"><span
                                    class="iconify" data-icon="ant-design:edit-filled"></span> Edit
                                Sponsor</button>
                            <button type="button" class="popup-action-button" id="deleteItem" data-id=<?php echo e($data->id); ?>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $(document).on("click", "#deleteItem", function(e) {
                ...
                swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: window.origin +
                                '/admin/sponsor/destroy/sponsor-banner-index',
                            type: "POST",
                            dataType: "json",
                            headers: {
            ...
            $(document).on("click", "#editBtn", function(e) {
                ...
                $('.loading-spinner').css("display", "flex");
                $.ajax({
                    url: window.origin + '/admin/sponsor/sponsor-banner-edit',
                    type: "POST",
                    dataType: "json",
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            ...
            $(document).on("click", "#editSponsorBanner", function(e) {
                ...
                $('.loading-spinner').css("display", "flex");
                $.ajax({
                    url: window.origin + '/admin/sponsor/sponsor-banner-update',
                    type: 'POST',
                    dataType: "json",
                    processData: false,
                    contentType: false,
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ccninfot/movieflix.ccninfotech.com/resources/views/sponsor/sponsorBannerIndex.blade.php ENDPATH**/ ?>