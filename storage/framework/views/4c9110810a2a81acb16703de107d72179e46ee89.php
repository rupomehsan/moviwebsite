        ...
        <div class="row">
            ...
            <div class="col-md-8 content-title">
                <div class="row">
                    <div class="col-md-2">
                        <span class="title">
                            <a href="/admin/series/series-category-view" class="title-btn red" id="category">Series
                                Category</a>
                        </span>
                ...
                <div class="row create-menus margin-top-20">
                    ...
                    <div class="col-md-3">
                        <button type="button" class="" data-toggle="modal" data-target="#createModal"
                            id="seriesCategoryCreate">
                            <span class="iconify" data-icon="akar-icons:circle-plus-fill"></span>&nbsp; Add Series
                            Category
                        </button>
                    </div>
            ...
            <div class="col-md-4 text-right">
                <form action="/admin/series/series-category-filter" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php $__env->startPush('custom-js'); ?>
    <script type="text/javascript">
        $(function() {
            ...
            $(document).on("click", "#deleteItem", function(e) {
                ...
                swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: window.origin + '/admin/series/destroy/SeriesCategory',
                            type: "POST",
                            dataType: "json",
                            headers: {
            ...
            //series category edit Modal
            $(document).on("click", "#categoryEditBtn", function(e) {
                e.preventDefault();
                var id = $(this).attr("data-id");
                $('.loading-spinner').css("display", "flex");
                $.ajax({
                    url: window.origin + '/admin/series/series-category-edit',
                    type: "POST",
                    dataType: "json",
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            ...
            $(document).on("click", "#editCategory", function(e) {
                ...
                $('.loading-spinner').css("display", "flex");
                $.ajax({
                    url: window.origin + '/admin/series/series-category-update',
                    type: 'POST',
                    dataType: "json",
                    processData: false,
                    contentType: false,
                    ...
                    success: function(res) {
                        toastr.success('Series Category updated successfully', res, options);
                        setTimeout(location.reload.bind(location), 1000);
                    },
                    error: function(jqXhr, ajaxOptions, thrownError) {
                        if (jqXhr.status == 422) {
            ...
            $(document).on("click", "#seriesCategoryCreate", function(e) {
                ...
                $('.loading-spinner').css("display", "flex");
                $.ajax({
                    url: window.origin + '/admin/series/series-category-create',
                    type: "POST",
                    dataType: "json",
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            ...
            $(document).on("click", "#createSeriesCategory", function(e) {
                ...
                $('.loading-spinner').css("display", "flex");
                $.ajax({
                    url: window.origin + '/admin/series/series-category-store',
                    type: 'POST',
                    dataType: "json",
                    processData: false,
                    contentType: false,
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ccninfot/movieflix.ccninfotech.com/resources/views/series/seriesCategoryIndex.blade.php ENDPATH**/ ?>