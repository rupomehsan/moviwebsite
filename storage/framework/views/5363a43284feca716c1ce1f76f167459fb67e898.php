        ...
        <div class="container">
            <div class="row margin-top-40">
                <div class="col-md-6 profile-info">
                    <h2 class="margin-top-40"><?php echo e($profile->name ?? ''); ?></h2> <a href="/edit-profile"
                    ...
                    <div class="margin-top-20 profile-info-detail"><i class="fas fa-phone-alt"></i>&nbsp; <span class="bold">Phone No :</span>
                        <?php echo e($profile->phone ?? ''); ?></div>
                    <div class="margin-top-20 profile-info-detail"><i class="far fa-envelope"></i>&nbsp; <span class="bold">Email :</span>
                        <?php echo e($profile->email ?? ''); ?></div>

                    
                </div>
                <div class="col-md-6 text-center profile-image">
                    <?php if(!empty($profile->image)): ?>
                        <img src="<?php echo e(URL::to('/')); ?>/uploads/user/<?php echo e($profile->image); ?>" alt="<?php echo e($profile->name); ?>"
                            title="<?php echo e($profile->name); ?>" />
                    <?php else: ?>
...
<?php echo $__env->make('frontend.layouts.client.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ccninfot/movieflix.ccninfotech.com/resources/views/frontend/client/profile.blade.php ENDPATH**/ ?>