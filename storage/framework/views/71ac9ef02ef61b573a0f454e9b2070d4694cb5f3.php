                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="table-action-btn edit-action-btn" data-toggle="modal"
                                            data-target="#createModal" id="seasonEditBtn" data-id="<?php echo e($data->id); ?>"
                                            title="Edit">
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ccninfot/movieflix.ccninfotech.com/resources/views/series/seasonIndex.blade.php ENDPATH**/ ?>