    ...
    <div class="content-heading">
        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <span class="sub-title">
                            <a href="/admin/category/sub-category-view" class="title-btn red" id="subCategory">Sub Category</a>
                        </span>
                ...
                <div class="row create-menus margin-top-20">
                    ...
                    <div class="col-md-3">
                        <button type="button" class="" data-toggle="modal" data-target="#createModal"
                            id="subCategoryCreate">
                            <span class="iconify" data-icon="akar-icons:circle-plus-fill"></span>&nbsp; Add Sub
                            Category
                        </button>
                    </div>
            ...
            <div class="col-md-4 text-right">
                <form action="/admin/category/sub-category-filter" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                            ...
                            <?php if(!$target->isEmpty()): ?>
                                <?php $__currentLoopData = $target; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e(!empty($data->category) ? $data->category->name : ''); ?></td>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $(document).on("click", "#deleteItem", function(e) {
                ...
                swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: window.origin + '/admin/category/destroy/SubCategory',
                            type: "POST",
                            dataType: "json",
                            headers: {
            ...
            $(document).on("click", "#categoryEditBtn", function(e) {
                ...
                $('.loading-spinner').css("display", "flex");
                $.ajax({
                    url: window.origin + '/admin/category/sub-category-edit',
                    type: "POST",
                    dataType: "json",
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            ...
            $(document).on("click", "#editCategory", function(e) {
                ...
                $('.loading-spinner').css("display", "flex");
                $.ajax({
                    url: window.origin + '/admin/category/sub-category-update',
                    type: 'POST',
                    dataType: "json",
                    processData: false,
                    contentType: false,
                    ...
                    success: function(res) {
                        toastr.success('Sub Category updated successfully', res, options);
                        setTimeout(location.reload.bind(location), 1000);
                    },
                    error: function(jqXhr, ajaxOptions, thrownError) {
                        if (jqXhr.status == 422) {
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ccninfot/movieflix.ccninfotech.com/resources/views/category/subCategoryIndex.blade.php ENDPATH**/ ?>