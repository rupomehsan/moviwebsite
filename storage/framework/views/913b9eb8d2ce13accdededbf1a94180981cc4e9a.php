                 ...
                 <div class="row">
                     <div class="col-md-6">
                         ...
                         <div class="legal-info"><a
                                 href="<?php echo e(url('/legal-information?type=about_us')); ?>">ABOUT US</a></div>
                         <div class="legal-info"><a href="#">CONTACT US</a></div>
                         <div class="legal-info"><a href="#">PACKAGES</a></div>
                     </div>
                     <div class="col-md-6">
                         <div class="legal-info"><a
                                 href="<?php echo e(url('/legal-information?type=terms_policy')); ?>">TERMS &
                                 CONDITIONS</a></div>
                         <div class="legal-info"><a
                                 href="<?php echo e(url('/legal-information?type=privacy_policy')); ?>">PRIVECY
                                 POLICY</a></div>
                         <div class="legal-info"><a
                                 href="<?php echo e(url('/legal-information?type=cookies_policy')); ?>">COOKIES
                                 POLICY</a></div>
                     </div>
                 </div>
             </div>
...
<?php /**PATH /home/projectx/Desktop/laravelProjects/flix_ccn/resources/views/frontend/partials/client/footer.blade.php ENDPATH**/ ?>