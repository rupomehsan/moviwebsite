<?php $__env->startSection('content'); ?>
                                            ...
                                            <div class="video-title margin-top-54">
                                                ...
                                                <div class="video-details margin-top-10">
                                                    ...
                                                    <div class="details-line trailer">
                                                        <a href="#" class="watch-trailer-btn"
                                                ...
                                                <?php if(!empty($celibritiesArr)): ?>
                                                    <div class="video-casts margin-top-20">
                                                        ...
                                                        <div class="casts">
                                                            ...
                                                            <?php if(!empty($celibritiesArr[$data->id])): ?>
                                                                <?php $count = '1'; ?>
                ...
                <?php $__currentLoopData = $justAdded; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="card item homepage-video-slider  margin-top-20">
                        ...
                        <div class="homepage-video-details">
                            ...
                            <div class="trailer">
                                <a href="#" class="watch-trailer-btn" data-id="<?php echo e($data->trailer); ?>"
    ...
    <?php if(!empty($categoryShow)): ?>
        <?php $categorySerial = '1'; ?>
        <?php $__currentLoopData = $categoryShow; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="container margin-top-20">
                ...
                <!--Slides-->
                <div class="owl-carousel just-added-carousel owl-theme">
                    <?php $__currentLoopData = $categoryVideoInfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        $parentalContent = $data->is_parental == 'on' ? 'parental-image' : '';
                        ?>
...
<?php $__env->startPush('custom-js'); ?>
    <script>
        ...
        $(document).on("click", ".watch-trailer-btn", function(e) {
            ...
            if (trailer == '') {
                toastr.error('Error', 'No Trailer link', options);
            }
            // alert(trailer);
...
<?php echo $__env->make('frontend.layouts.client.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/projectx/Desktop/laravelProjects/flix_ccn/resources/views/frontend/client/index.blade.php ENDPATH**/ ?>