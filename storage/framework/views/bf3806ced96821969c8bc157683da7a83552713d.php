...
<body>
                ...
                <div class="modal-body">
                    <form id="requestAddForm" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="actions margin-top-20 text-left">
                            <button class="submit" type="submit" id="addRequest">Save</button>
    ...
    <?php $__env->stopPush(); ?>
<?php /**PATH /home/projectx/Desktop/laravelProjects/movieflix-main/resources/views/frontend/partials/client/header.blade.php ENDPATH**/ ?>