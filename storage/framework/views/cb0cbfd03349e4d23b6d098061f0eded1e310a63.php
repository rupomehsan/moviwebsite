                        ...
                        <?php $__currentLoopData = $target; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="onoffswitch">
                                        <input type="checkbox" class="onoffswitch-checkbox"
                                            data-id="<?php echo e($data->comment_id); ?>"
                                            id="commentHideShow<?php echo e($data->comment_id); ?>" tabindex="0"
                                            <?php echo $data->comments_status == 'active' ? 'checked' : ''; ?>>
                                ...
                                <td class="table-actions text-center">
                                    <button type="submit" id="deleteItem" data-id=<?php echo e($data->comment_id); ?>
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ccninfot/movieflix.ccninfotech.com/resources/views/comment/index.blade.php ENDPATH**/ ?>