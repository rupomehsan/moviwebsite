<div class="modal-content">
    ...
    <form id="genreCreateForm" method="POST" enctype="multipart/form-data">
        ...
        <div class="actions margin-top-10">
            <button class="submit margin-top-10" type="submit" id="createGenre">Save</button>
            <button type="button" class="cancel margin-top-10" data-dismiss="modal">Cancel</button>
        </div>
    </form>

</div>
<?php /**PATH /home/ccninfot/movieflix.ccninfotech.com/resources/views/genres/create.blade.php ENDPATH**/ ?>