    ...
    <div class="content-heading">
        <div class="row">
            ...
            <div class="col-md-4 text-right">
                <form action="/admin/user/filter" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
        ...
        <div class="margin-top-20 action-buttons">
            <a class="single-action" href="/admin/user/create">
        ...
        $(document).on("click", "#deleteItem", function(e) {
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: window.origin + '/admin/user/destroy',
                        type: "POST",
                        dataType: "json",
                        headers: {
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ccninfot/movieflix.ccninfotech.com/resources/views/user/index.blade.php ENDPATH**/ ?>