                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control create-form" id="app_name" name="app_name"
                                                value="<?php echo e(env('APP_NAME')); ?>" rows="0" placeholder="APP NAME">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control create-form" id="app_url" name="app_url" rows="0"
                                                placeholder="App URL" value="<?php echo e(env('APP_URL')); ?>">
                                            <span class="text-danger"></span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <form id="newsCreateForm" method="POST" enctype="multipart/form-data" action="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control create-form" id="db_name" name="db_name" rows="0"
                                                placeholder="DATABASE NAME" value="<?php echo e(env('DB_DATABASE')); ?>">
                                            <span class="text-danger"></span>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input class="form-control create-form" id="db_username" name="db_username"
                                                ...
                                                value="<?php echo e(env('DB_USERNAME')); ?>">
                                            <span class="text-danger"></span>
                                        </div>
                                        <div class="form-group">
...
<?php /**PATH /home/projectx/Desktop/laravelProjects/movieflix-main/resources/views/installation/installer.blade.php ENDPATH**/ ?>