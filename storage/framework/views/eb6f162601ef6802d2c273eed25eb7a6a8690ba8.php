        ...
        <div class="row">
            ...
            <div class="col-md-8 content-title">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <span class="title">
                            <a href="/admin/series" class="title-btn red" id="category">Series Name</a>
                        </span>
                ...
                <div class="row create-menus margin-top-20">
                    <div class="col-md-3">
                        <button type="button" class="" data-toggle="modal" data-target="#createModal"
                            id="seriesCreate">
                            <span class="iconify" data-icon="bi:plus-circle-fill"></span> &nbsp; Add Series
                        </button>
                    </div>
            ...
            <div class="col-md-4 text-right">
                <form action="/admin/series/filter" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="table-action-btn edit-action-btn" data-toggle="modal"
                                            data-target="#createModal" id="seriesEditBtn" data-id="<?php echo e($data->id); ?>"
                                            title="Edit">
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $(document).on("click", "#deleteItem", function(e) {
                ...
                swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: window.origin + '/admin/series/destroy/Series',
                            type: "POST",
                            dataType: "json",
                            headers: {
            ...
            $(document).on("click", "#seriesCreate", function(e) {
                ...
                $('.loading-spinner').css("display", "flex");
                $.ajax({
                    url: window.origin + '/admin/series/series-create',
                    type: "POST",
                    dataType: "json",
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            ...
            $(document).on("click", "#createSeries", function(e) {
                ...
                $('.loading-spinner').css("display", "flex");
                $.ajax({
                    url: window.origin + '/admin/series/series-store',
                    type: 'POST',
                    dataType: "json",
                    processData: false,
                    contentType: false,
            ...
            $(document).on("click", "#seriesEditBtn", function(e) {
                ...
                $('.loading-spinner').css("display", "flex");
                $.ajax({
                    url: window.origin + '/admin/series/edit',
                    type: "POST",
                    dataType: "json",
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            ...
            $(document).on("click", "#editSeries", function(e) {
                ...
                $('.loading-spinner').css("display", "flex");
                $.ajax({
                    url: window.origin + '/admin/series/update',
                    type: 'POST',
                    dataType: "json",
                    processData: false,
                    contentType: false,
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ccninfot/movieflix.ccninfotech.com/resources/views/series/seriesIndex.blade.php ENDPATH**/ ?>