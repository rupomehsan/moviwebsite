                        ...
                        <div class="country-image text-center">
                            ...
                            <?php else: ?>
                                <?php if(!empty($data->image)): ?>
                                    <img src="<?php echo e(URL::to('/')); ?>/uploads/country/<?php echo e($data->image); ?>"
                        ...
                        <div class="actions-area">
                            ...
                            <div class="dropdown-menu single-content-wraper">
                                <button title="Edit" class="popup-action-button" type="button" data-toggle="modal"
                                    data-target="#crateModal" id="editBtn" data-id="<?php echo e($data->id); ?>"><span
...
<?php echo $__env->make('layouts.default.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ccninfot/movieflix.ccninfotech.com/resources/views/country/index.blade.php ENDPATH**/ ?>