<div class="modal-content">
    ...
    <form id="celebrityTypeUpdateForm" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group margin-top-20">
            <input name="name" type="text" class="form-control create-form" id="name" placeholder="Artist Type Name" value="<?php echo e($target->name); ?>">
        </div>
...
<?php /**PATH /home/ccninfot/movieflix.ccninfotech.com/resources/views/celebrity/typeEdit.blade.php ENDPATH**/ ?>